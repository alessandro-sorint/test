...
type TriggersController interface {
	...
	StopTriggers(w http.ResponseWriter, r *http.Request)
	StartTriggers(w http.ResponseWriter, r *http.Request)
...
type UserController interface {
	...
	GetAllAgolaRunningRuns(w http.ResponseWriter, r *http.Request)
}
